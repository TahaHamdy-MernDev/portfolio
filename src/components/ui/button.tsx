...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className = "", variant = "primary", size = "md", children, ...props }, ref) => {
    ...
    const variants = {
      ...
      secondary: "bg-transparent text-white border border-white hover:bg-white/10 active:bg-white/15",
      outline: "bg-transparent text-zinc-400 border border-zinc-800 hover:border-white hover:text-white",
      ghost: "bg-transparent text-zinc-400 hover:text-white hover:bg-zinc-900/30 active:bg-zinc-900/50",
    };
